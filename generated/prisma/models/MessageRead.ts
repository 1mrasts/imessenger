...
export type MessageReadWhereInput = {
  ...
  message_id?: Prisma.IntFilter<"MessageRead"> | number
  user_id?: Prisma.StringFilter<"MessageRead"> | string
...
export type MessageReadScalarWhereWithAggregatesInput = {
  ...
  message_id?: Prisma.IntWithAggregatesFilter<"MessageRead"> | number
  user_id?: Prisma.StringWithAggregatesFilter<"MessageRead"> | string
...
export type MessageReadOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"message_id" | "user_id" | "read_at", ExtArgs["result"]["messageRead"]>
...
export interface MessageReadDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const messageReadWithMessage_idOnly = await prisma.messageRead.findMany({ select: { message_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many MessageReads and only return the `message_id`
   * const messageReadWithMessage_idOnly = await prisma.messageRead.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more MessageReads and only return the `message_id`
   * const messageReadWithMessage_idOnly = await prisma.messageRead.updateManyAndReturn({
   *   select: { message_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface MessageReadFieldRefs {
  readonly message_id: Prisma.FieldRef<"MessageRead", 'Int'>
